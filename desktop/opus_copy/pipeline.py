    ...
    def run(self, url: str, max_clips: int = 5, progress=None, output_dir: Path | None = None, subtitle_style: SubtitleStyle | None = None, language: str = "pt") -> list[Path]:
        ...
        try:
            ...
            metadata = [{
                ...
                "statistics": clip_statistics(transcript, clip, clip.scores),
            ...
            report("Enquadrando automaticamente os assuntos e renderizando clips 9:16…", 81)
            renderer = ClipRenderer(subtitle_style=subtitle_style, auto_reframe=True)
